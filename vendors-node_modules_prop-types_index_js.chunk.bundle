(self["webpackChunknews"] = self["webpackChunknews"] || []).push([["vendors-node_modules_prop-types_index_js"],{
...
}]);//# sourceMappingURL=vendors-node_modules_prop-types_index_js.chunk.bundle.map?platform=ios