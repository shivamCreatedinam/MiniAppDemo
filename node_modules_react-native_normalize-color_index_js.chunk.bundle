"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([["node_modules_react-native_normalize-color_index_js"],{
...
}]);//# sourceMappingURL=node_modules_react-native_normalize-color_index_js.chunk.bundle.map?platform=ios